...
export default function ConhecimentoPage() {
  ...
  return (
    <>
      <PageHeader eyebrow="Padrão · Aprendizado" title="Base de conhecimento" description={`Processos e modelos para uma operação de ${niche.label.toLowerCase()} mais consistente.`} action={null} />
