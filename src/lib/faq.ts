...
export const faqItems: FaqItem[] = [
  ...
  { id: "logo", category: "Personalização", question: "Quais formatos de logo são aceitos?", answer: "PNG, JPG e WebP, com até 5 MB. Se a empresa ainda não tiver logo, usamos um monograma temporário criado a partir do nome do negócio.", related: "Prefira arquivos com fundo transparente." },
