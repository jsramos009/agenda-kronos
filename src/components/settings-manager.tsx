...
type SettingsValues = {
  ...
  logoUrl: string | null;
  agenda: { start: string; end: string; bookingNotice: string; cancellationNotice: string; days: number[] };
...
export function SettingsManager({ demo, initialSettings }: { demo: boolean; initialSettings: SettingsValues | null }) {
  ...
  const [agenda, setAgenda] = useState(initialSettings?.agenda ?? { start: "08:00", end: "18:00", bookingNotice: "60", cancellationNotice: "240", days: [1, 2, 3, 4, 5, 6] });
  ...
  const restore = () => {
    ...
    setAgenda({ start: "08:00", end: "18:00", bookingNotice: "60", cancellationNotice: "240", days: [1, 2, 3, 4, 5, 6] });
